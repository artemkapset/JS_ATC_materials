...
exports.config = {
  ...
  specs: ["./test/specs/POdemo.spec.js"],
  // specs: ['./test/specs/table_example.spec.js'],
  ...
  capabilities: [
    {
      ...
      browserName: "chrome",
      "goog:chromeOptions": {
        args: ["incognito", "--ignore-certificate-errors", "start-maximized"],
      },
  ...
  before: function (capabilities, specs) {
    require(`expect-webdriverio`).setOptions({ wait: 3000, interval: 200 })
  },
  /**
